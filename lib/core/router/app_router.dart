...
import '../../features/profile/presentation/pages/friends_list_page_real.dart';
...
import '../../features/matches/presentation/pages/create_match_page.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/friends',
        name: 'friends',
        builder: (context, state) => const FriendsListPageReal(),
      ),
      GoRoute(
        path: '/radial-search',
        name: 'radial-search',
